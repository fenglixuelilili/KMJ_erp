            ...
            <el-table
                ...
                <el-table-column
                    ...
                    <template slot-scope="props">
                        <img v-if="props.row.default_image" :src="props.row.default_image" style="width: 100%;">
                    </template>
                </el-table-column>
                <el-table-column
                        prop="title"
...
<script>
    import {WstoreList, WoutstockTotal} from '../../api/api';
    export default {
        data() {
            return {
                pickerOptions: {
        ...
        methods: {
            ...
            educe(){
                window.open(`${this.$store.state.urlBackstage}/outstocks/exportSkusTotal?access_token=${sessionStorage.getItem('access_token')}&sku_title=${this.filters.sku_title}&outstock_bn=${this.filters.instock_bn}&store_id=${this.filters.waimaistore_id}&outstock_start_date=${this.instock_start_date}&outstock_end_date=${this.instock_end_date}`)
            },
            reload(){
                this.valueI = [];
            ...
            getItems() {
                ...
                var parm = {
                    ...
                    outstock_start_date: this.instock_start_date,
                    outstock_end_date: this.instock_end_date,
                    page: this.page,
                    per_page: this.per_page
                }
                WoutstockTotal(parm).then((res) => {

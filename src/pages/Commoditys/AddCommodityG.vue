    ...
    <section class='bg' id="gg">
        ...
        <div class="shadow">
            ...
            <el-row  class='bg' style="margin-top: 10px;">
                <el-col :span='21'>
                    <el-form label-width="120px" :rules="rules" style="width: 100%;">
                        <el-row>
                            <el-col :span="10">
...
<script>
    import { getPredefined, addItems, getItemsList} from '../../api/api'
    export default {
        data () {
            return {
                rules: {

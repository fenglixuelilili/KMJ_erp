<template>
    <section>
        ...
        <div class="pt">
            ...
            <el-row>
                <el-col :span="24" style='margin-bottom: 20px;border-bottom: 1px solid #ccc;'>
...
<script>
    ...
    export default{
        ...
        methods: {
            ...
            detail(index){
                this.$router.push({path: "/Public", query: {tid: this.tableData[index].tid, h: 1}})
            },

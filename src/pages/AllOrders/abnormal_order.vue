...
<script>
    import {getOrderAbnormal, editMemo, closeOrder, regainOrder} from '../../api/api'
    export default{
        data(){
            return {
                order_id: "",
                ...
                shipping_status: '',
                logistics_company: "",
                optionsI: [{key: '全部', value: ''}, {key: '待支付', value: 'WAIT_BUYER_PAY'}, {
                    key: '待发货',
                ...
                optionsII: [{key: '全部', value: ''}, {key: '已发货', value: 1}, {key: '未发货', value: 0}],
                optionsIII: [{key: '快买酒官方旗舰店', value: 1}],
                tableData: [],
                total: 200,
                per_page: 10,
                page: 1,
        ...
        methods: {
            getAorderes(){
                ...
                getOrderAbnormal(parm).then((res) => {
...
//                        arr = [this.tableData[i].orders];
//                        this.tableData[i].orders = arr;
//                    }
            ...
            detail(index){
                this.$router.push({path: "/Public", query: {tid: this.tableData[index].tid, ab: "ab", e: 1}})
            },
            regain(index){
                regainOrder(this.tableData[index].tid).then((res) => {

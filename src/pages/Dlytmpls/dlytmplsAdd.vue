    ...
    <section v-loading="isLoading" element-loading-text="数据传输中">
        <div class='bg' id="gg">
            ...
            <div v-if='bool' class="setArea">
                ...
                <span v-for="(city,index) in area" style="width: 33%;display: inline-block;height: 30px;" @click="move(city,$event,-1)" :key="index">
...
<script>
    import {getWareHousesList, getCorp, AreaData, addDlys, getAreaData} from './../../api/api'
    export default{
        data () {
            return {
                bool: false,
...
//                this.warehouse.unshift({warehouse_name: "全部仓库", warehouse_id: "all"})
        ...
        methods: {
            ...
            getback(){
                this.$router.push({path: "/warehouses/dlytmpls/manager/list"})
            },

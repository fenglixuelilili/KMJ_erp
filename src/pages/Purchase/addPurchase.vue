...
<template>
    <section class='bg' id="gg">
        ...
        <div class="shadow">
                ...
                <el-col :span='21'>
                    <el-form :inline="true" label-width="120px" :model="form" ref='form' :rules="rules">
                        ...
                        <el-form-item label="供应商" prop="requires">
                            <el-select v-model="form.supplier_id" clearable filterable placeholder="请选择" class="col" style='width: 280px;'>
                                <el-option
            ...
            <el-row class='bg'>
                <el-col :span='2' class='cen' style='margin-right: 13px'>
                    表格
                </el-col>
                <el-col :span='21'>
                    ...
                    <el-table
                        ...
                        <el-table-column
                            ...
                            <template slot-scope="scope">
                                ...
                                <input v-model="scope.row.num" style="width: 99%;" class="el-input__inner" placeholder="请输入数量">
                            </template>
                        </el-table-column>
                        <el-table-column
                                label="采购单价(元)"
                            ...
                            <template slot-scope="scope">
                                ...
                                <input v-model="scope.row.price" style="width: 99%;" class="el-input__inner" placeholder="请输入单价">
                            </template>
                        </el-table-column>
                        <el-table-column
                                label="运费(选填)"
                            ...
                            <template slot-scope="scope">
                                ...
                                <input v-model="scope.row.post_fee" style="width: 99%;" class="el-input__inner" placeholder="请输入运费">
                            </template>
                        </el-table-column>
                        <el-table-column
                                prop="weight"
...
<script>
    import { getPredefined, getItemsList, getCategoriesList, getSuppliersList, addPurchase } from '../../api/api'
    export default {
        data () {
            return {
                defaultProps: {

...
<script>
    ...
    export default{
        ...
        methods: {
            educe(){
                window.open(`${this.$store.state.urlBackstage}/finance/exportOrderSku?access_token=${sessionStorage.getItem('access_token')}&store_id=${this.store_id}&startTime=${this.start_date}&endTime=${this.end_date}&platform=${this.platform}&orderId=${this.tids}`)
            },
            timeC(str){

...
<script>
    import { getItemList, editActivityItem, storeList } from '../../api/api'
    export default {
        data () {
            return {
                pickerOptions: {
        ...
        created () {
            let platform = this.$route.query.data.platform.split(",");
            ...
            this.value = [this.$route.query.data.activity_start,this.$route.query.data.activity_end];
            this.start_date = this.$route.query.data.activity_start;
            this.end_date = this.$route.query.data.activity_end;
            this.tableDataI = [this.$route.query.data.item];
            this.tableStoreI = this.$route.query.data.stores;
            this.memo = this.$route.query.data.memo;
            this.getSkusList();
            this.getStoreList();
        },
        methods: {
            ...
            getback(){
                this.$router.push({path:'/waimaiitems/activity/list',query:{criteria: this.$route.query.criteria}})
            },
            platformC(val){
                if (!val.platform){
                    return;
            ...
            getStoreList(){
                ...
                storeList(parm).then((res) => {
                    ...
                    for (let i = 0; i < this.tableStoreII.length; i++) {
            ...
            subMit(){
                let parm = {
                    ...
                    memo: this.memo,
                    stores: JSON.stringify(this.tableStoreI)
                }
                ...
                editActivityItem(this.$route.query.data.id,parm).then((res)=>{

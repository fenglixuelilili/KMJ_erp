                    ...
                    <el-form :model="form" label-width="120px">
                        ...
                        <el-row>
                            <el-col :span="24" class='cb'>
                                <el-button type="primary" class='btnw' @click="getWMorderes" :size="size">查询</el-button>
...
<script>
    import {storeList, getWMorders} from "../../api/api"
    export default{
        data() {
            return {
                form: {},
        ...
        methods: {
            ...
            derive(){
                ...
                window.open(`${this.$store.state.urlBackstage}/finance/exportOrders?access_token=${sessionStorage.getItem('access_token')}&orderId=${this.tids}&store_id=${this.store_id}&startTime=${this.start_date}&endTime=${this.end_date}&platform=${this.platform}`)
            },
            source(val){
                switch (val.source) {
                    case 'jddj':

...
<script>
    ...
    export default{
        ...
        methods: {
            educe(){
                window.open(`${this.$store.state.urlBackstageApi}/finance/trades/itemsInfo/export?access_token=${sessionStorage.getItem('access_token')}&store_id=${this.store_id}&start_date=${this.start_date}&end_date=${this.end_date}&tid=${this.tids}&sku_title=${this.sku_title}`)
            },
            timeC(str){

    ...
    <section class='bg' id="gg">
                        ...
                        <el-row>
                            <el-col :span="10">
                                <el-form-item label="入库编号：" prop="instock_bn">
                                    <el-input v-model="instockForm.instock_bn" placeholder="请输入入库编号"
                                              class="col"></el-input>
                                </el-form-item>
                            </el-col>
                            <el-col :span="10">
                        ...
                        <el-row>
                            <el-col :span="10">
                                <el-form-item label="入库类型：">
                                    <el-select v-model="instockForm.clasee" placeholder="请选择入库类型" clearable
                                               style="width: 70%;" @change="clearBoth">
                                        <el-option
                            ...
                            <el-col :span="14">
                                <el-form-item label="采购单号：" v-if="instockForm.clasee == 1">
                                    <el-select v-model="purchase_order" placeholder="请选择采购单号" clearable filterable
                                               @change="purchse">
                                        <el-option
                                ...
                                <el-form-item label="借货出库单号：" v-if="instockForm.clasee == 16">
                                    <el-select v-model="outstock_ids" placeholder="请选择出库单号" clearable
                                               @change="setOutorder">
                                        <el-option
            ...
            <el-row class='bg'>
                <el-col :span='22' :offset="1">
                    <div style='padding: 10px;padding-left: 0;'>
                        <el-button type="primary" style='width: 150px;' @click='show'
                                   v-if="instockForm.clasee != 1&&instockForm.clasee != 2&&instockForm.clasee != 16">
                            选择物料
                        </el-button>
                    </div>
                    <el-table
                        ...
                        <el-table-column label="入库单价" width="95">
                            <template slot-scope="props">
        ...
        <el-row class="bg" style='text-align: center;margin: 0;'>
            ...
            <el-button type="primary"
                       ...
                       @click="$router.replace('/iostocks/instocks/manager/list')">取消
            </el-button>
        </el-row>
    </section>
</template>
...
//            获取分类列表
            ...
            if (this.$route.query.instock_id) {
                getInstocksDetail(this.$route.query.instock_id).then((res) => {
                    this.bol = true;
                    this.instockForm.clasee = 5;
                    this.tableDataI = res.data.items;
                    for (let i = 0; i < this.tableDataI.length; i++) {
                        this.$set(this.tableDataI[i],'shelf_life_type', "");
                        this.$set(this.tableDataI[i],'shelf_life', 0);
                        this.$set(this.tableDataI[i],'num', 1);
                        this.$set(this.tableDataI[i],'price', 0);
                        this.$set(this.tableDataI[i],'production_date', "");
        ...
        methods: {
            clearBoth(val){
                ...
                if (val) {
                    this.tableDataI = [];
                    this.optionsIV_items = [];
                    this.optionsVI_items = [];
                    this.outstock_data = [];
                    for (let i in  this.production_date) {
                        this.production_date[i] = ""
                    }
                    for (let i in  this.shelf_life_type) {
                        this.shelf_life_type[i] = ""
                    }
                }
            },
            setOutorder(){
